...
static void init_medicines() {
    ...
    struct {
        const char* c_name; const char* t_name; const char* alias; float price; int category; int depts[6];
    } med_data[20] = {
        {"乙酰水杨酸", "拜阿司匹林", "阿司匹林", 15.5f, 0, {1,0,0,0,0,0}},
        {"阿莫西林胶囊", "阿莫仙", "消炎药", 22.0f, 0, {1,0,0,0,0,0}},
        {"对乙酰氨基酚", "泰诺林", "扑热息痛", 18.0f, 0, {1,0,0,0,0,0}},
        {"布洛芬缓释胶囊", "芬必得", "止痛药", 25.5f, 1, {1,0,0,0,0,0}},
        {"头孢克肟分散片", "世福素", "头孢", 35.0f, 1, {1,0,0,0,0,0}},

        {"蒙脱石散", "思密达", "止泻药", 28.0f, 1, {0,1,1,0,1,0}},
        {"奥美拉唑肠溶胶囊", "洛赛克", "胃药", 45.0f, 1, {0,1,1,1,0,0}},
        {"二甲双胍肠溶片", "格华止", "降糖药", 30.0f, 0, {0,0,1,0,0,0}},
        {"硝苯地平控释片", "拜新同", "降压药", 40.0f, 0, {0,1,1,0,0,0}},
        {"阿奇霉素分散片", "希舒美", "消炎药", 32.0f, 1, {1,0,0,0,0,0}},

        {"小儿氨酚黄那敏颗粒", "护彤", "小儿感冒药", 15.0f, 1, {0,1,0,0,1,0}},
        {"复方丁香开胃贴", "丁桂儿脐贴", "宝宝肚脐贴", 20.0f, 2, {0,0,0,0,1,0}},
        {"头孢丙烯干混悬剂", "施复捷", "小儿头孢", 42.0f, 1, {0,1,0,0,1,0}},

        {"碘伏消毒液", "聚维酮碘", "碘酒", 8.0f, 2, {1,0,0,0,0,0}},
        {"红霉素软膏", "红霉素", "消炎膏", 5.0f, 0, {1,0,0,0,0,0}},
        {"云南白药气雾剂", "云南白药", "喷雾", 55.0f, 2, {0,1,0,1,0,0}},

        {"甲硝唑氯己定洗剂", "洁尔阴", "洗液", 25.0f, 2, {0,0,0,0,0,1}},
        {"盐酸特比萘芬乳膏", "丁克", "脚气膏", 18.0f, 1, {0,0,1,1,0,0}},
        {"硝酸咪康唑栓", "达克宁栓", "妇科栓剂", 38.0f, 1, {0,0,0,0,0,1}},

        {"肾上腺素注射液", "副肾", "急救药", 12.0f, 0, {0,1,0,1,0,0}}
    };
    ...
    for (int i = 0; i < 20; i++) {
        ...
        m->category = med_data[i].category;
